...
from minemeld.flask.aaa import MMBlueprint
...
BLUEPRINT = MMBlueprint('extendedtaxiidiscovery', __name__, url_prefix='')
...
_SERVICE_INSTANCES = [
    {
        ...
        'path': 'extendedtaxii-discovery-service'
    },
    {
        'type': libtaxii.constants.SVC_COLLECTION_MANAGEMENT,
        'path': 'extendedtaxii-collection-management-service'
    },
    {
        'type': libtaxii.constants.SVC_POLL,
        'path': 'extendedtaxii-poll-service'
    }
]


@BLUEPRINT.route('/extendedtaxii-discovery-service', methods=['POST'], feeds=True, read_write=False)
@taxii_check
